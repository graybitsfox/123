...
public class IntelligentNPCRenderer extends BipedEntityRenderer<NPCEntity, PlayerEntityModel<NPCEntity>> {

    private static final Identifier STEVE_TEXTURE = Identifier.of("minecraft", "textures/entity/steve.png");

    public IntelligentNPCRenderer(EntityRendererFactory.Context ctx) {
